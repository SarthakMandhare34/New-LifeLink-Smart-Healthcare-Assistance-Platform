  ...
  return (
    <div className="dashboard-workspace">
      ...
      <header className="mb-4 flex items-center gap-3" style={{ marginBottom: 'var(--spacing-5)' }}>
        <div style={{ width: 52, height: 52, borderRadius: '8px', background: 'var(--color-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <section className="bento-grid">
        ...
        <Card variant="default" className="bento-col-8" style={{ padding: 'clamp(16px, 4vw, 28px)' }}>
        ...
        <Card variant="default" className="bento-col-4" style={{ padding: 'clamp(16px, 4vw, 28px)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <div>
            <div style={{ width: 44, height: 44, borderRadius: '8px', background: 'var(--color-surface-interactive)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '16px' }}>
          ...
          <div style={{ padding: '14px', borderRadius: '8px', background: 'var(--color-surface-interactive)', marginTop: '20px' }}>
